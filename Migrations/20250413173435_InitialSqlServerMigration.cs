    ...
    public partial class InitialSqlServerMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkoutPlanExercises", x => new { x.ExercisesId, x.WorkoutPlansId });
                    table.ForeignKey(
                        name: "FK_WorkoutPlanExercises_Exercises_ExercisesId",
                        column: x => x.ExercisesId,
                        principalTable: "Exercises",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkoutPlanExercises_WorkoutPlans_WorkoutPlansId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExercisePerformances", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ExercisePerformances_WorkoutSessions_WorkoutSessionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExercisePerformances_WorkoutSessionId",
                table: "ExercisePerformances",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkoutPlanExercises_WorkoutPlansId",
